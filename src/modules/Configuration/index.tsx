...
const Configuration: FC<ConfigurationProps> = ({
  ...
  return (
    <div className="border-l border-l-[#edeeee] h-full flex flex-col hidden">
      ...
      <div className="hidden pl-5 pr-5 pt-4 pb-4 text-sm flex flex-1 flex-col overflow-auto common-scrollbar">
        <div className="mb-6">
